========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto Progetto_PDS_1
========================================================================

La creazione guidata applicazione ha creato questa applicazione Progetto_PDS_1.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione Progetto_PDS_1.


Progetto_PDS_1.vcxproj
...
Progetto_PDS_1.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato Progetto_PDS_1.pch e il file dei tipi precompilato StdAfx.obj.
